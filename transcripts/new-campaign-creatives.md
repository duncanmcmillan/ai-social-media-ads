...
The Separate Ads versus Flexible Ad toggle controls how the copy is structured in Meta.
...
The app sends everything to the Facebook Marketing API: creates the campaign, each ad set, the ad creative objects, and the individual ads. You'll see a spinner while this happens — it can take 10 to 30 seconds depending on how many ads are being created.

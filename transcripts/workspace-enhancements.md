...
View-Through: how many days after someone simply sees your ad with no click should a conversion count. Options are 1 or 7 days.

The defaults — 7-day click, 1-day engaged view, 1-day view-through — are what Meta recommends for most campaigns. Longer windows show more conversions attributed to your ads but can overstate performance; shorter windows are more conservative.

The Naming and UTM section controls how your creatives and ad sets are named, and what UTM parameters get appended to your URLs.
...
For example, a creative name template using the campaign name and creative ID would produce names like Summer Sale dash cr underscore abc 123.

The UTM Parameters field is appended to your ad URL so you can track traffic sources in Google Analytics or your analytics platform. A typical value includes utm_source equals facebook, utm_medium equals paid, and utm_campaign set to the campaign name.
...
Beneficiary Name is the legal entity or brand that benefits from the ad — usually your company name.

Payer Name is who is paying for the ad — again usually your company, unless you're an agency running ads on a client's behalf.
